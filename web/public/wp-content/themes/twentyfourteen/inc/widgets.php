        ...
        if ($ephemera->have_posts()) :
            ...
            <h1 class="widget-title <?php echo esc_attr($format); ?>">
                <a class="entry-format"
                   href="<?php echo esc_url(get_post_format_link($format)); ?>"><?php echo $title; ?></a>
            </h1>
            <ol>
    ...
    function form($instance)
    {
        ...
        <select id="<?php echo esc_attr($this->get_field_id('format')); ?>" class="widefat"
            ...
            <?php foreach ($this->formats as $slug) : ?>
                <option
                    value="<?php echo esc_attr($slug); ?>"<?php selected($format, $slug); ?>><?php echo get_post_format_string($slug); ?></option>
            <?php endforeach; ?>
        </select>
    <?php
    }
