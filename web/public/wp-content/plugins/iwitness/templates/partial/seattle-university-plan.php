...
<div class="form-horizontal">
    <img class="pull-right" src="/wp-content/themes/iwitness/images/start-now/seatte_logo.png">
    <h5 class="text-uppercase-transform">Special Seattle University pricing</h5>
    <div class="form-group">
        <div class="col-md-10 col-md-offset-2">
            <label class="control-label" for="plan">
                <input type="radio" id="plan" name="plan" value="seattleyear"
                       class="required" checked="checked"
                       aria-required="true">
                <span class="price" id="price">$<?= $plans['seattleyear']['price'] ?></span>
