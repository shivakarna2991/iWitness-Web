...
//echo "<pre>"; print_r(iwitness_get_time_zone_options()); echo "</pre>";die;
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <div id="upload-container" >
                ...
                <a class="btn btn-primary btn-sm btn-block"
                   href="<?php echo iwitness_get_page_path(IWITNESS_PAGE_USER_PROFILE_VIEW_ID . '/' . IWITNESS_PAGE_CHANGE_PASSWORD_ID); ?>">
                    Reset Password</a>
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            ...
            <form id="profile-form" action="" method="POST" data-validate="true" role="form">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group <?php echo empty($user->timezone) ? 'error' : '' ?>">
                        ...
                        <div class="col-md-9">
							...
							<?php
					             ...
					             if(strpos($user_timezone, 'selected="selected') !== false)
									 $user_timezone = str_replace('" selected="selected', "", $user_timezone);
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group <?php echo ($user->gender === null) ? 'error' : '' ?>">
								...
								<div class="form-group <?php echo empty($user->subscriptionExpireAt) ? 'error' : '' ?>">
                                    <label for="exp_date" class="col-md-3 control-label">Expiry Date</label>

									<div class="col-md-9">
									<label for="ex_date" class="col-md-12 control-label"><?php echo iwitness_view_helper_format_datetime($user->subscriptionExpireAt) ?></label>
                                        <!--<input type="text" class="form-control" id="subscription_expiry" name="subscription_expiry"
                                               value="<?php //echo iwitness_view_helper_format_datetime($user->subscriptionExpireAt) ?>"
                                               data-rule-date = "true" placeholder="mm/dd/yy"> -->
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary" name="action" value="iwitness_do_update_user_profile">Save</button>
                        <button type="submit" class="btn btn-default" name="action" value="iwitness_do_update_user_profile_and_add_contact">Save & Add Contacts</button>
                    </div>
                </div>
            </form>
        </div>
