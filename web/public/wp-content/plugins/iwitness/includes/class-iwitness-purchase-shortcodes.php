...
if (!class_exists('iWitness_Purchase_Shortcodes')) :
    ...
    class iWitness_Purchase_Shortcodes
    {
        public function __construct()
        {
            ...
            add_shortcode('iwitness_special_promo_pricing', array($this, 'special_promo_pricing'));
         ...
         * Generic $14.95 'university' rate promo page
         */
        public static function special_promo_pricing()
        {
            return self::render_buy_now_view('promo');
        }
