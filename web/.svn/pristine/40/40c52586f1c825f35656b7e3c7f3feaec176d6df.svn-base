        ...
        <form data-validate="true" method="post"
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label for="email" class="control-label">Enter your email address or wireless number:</label>
                    <input type="text" value="<?= $view_model['email'] ?>" class="form-control" id="email" name="email" data-rule-required="true">
                </div>
